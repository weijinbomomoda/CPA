...
class ResNet(nn.Module):
    ...
    def __init__(self, block, blocks_num, num_classes=6, include_top=True):#block残差结构 include_top为了之后搭建更加复杂的网络
...
def resnet50(num_classes=6, include_top=True):
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes=num_classes, include_top=include_top)


def resnet152(num_classes=6, include_top=True):
