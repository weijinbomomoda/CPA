...
import sys
sys.path.append('/mnt/wjb/code/cls/mymodel/')
...
if __name__ == '__main__':
    model_path="/mnt/wjb/log/2023-08-17/save_models/fold_0_epoch_21.pt"
    cam_path='/mnt/wjb/log/pred'
    model = load_model(model_path)  # 预先训练
    for name in model.named_modules():
        print(name)
    print("model loaded!")
    image_path = '/mnt/wjb/media/CPA/test/JD0001_05MEQSQM_39.png'
