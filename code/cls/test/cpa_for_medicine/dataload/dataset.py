...
import sys
sys.path.append('/mnt/wjb/code/cls/mymodel/utiles')
import image_csv
...
def crop_img(df,is_train=True,base_crop_img='/mnt/wjb/media/CPA/cropData'):
    ...
    if not os.path.exists(crop_path):
        ...
        for img_path in path_lists:
            ...
            # print(idx,'---------->',crop_img_path)
        df.to_csv('/mnt/wjb/media/CPA/'+name,index=None)
    else:
